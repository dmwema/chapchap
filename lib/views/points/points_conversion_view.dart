                  ...
                  children: [
                    Column(
                      ...
                      children: [
                        ...
                        AppTexts.descriptionText("Veuillez choisir une règle de conversion")
                      ],
                    ),
                  ],
                ),
                              ...
                              if (user!.pointsBalance! < current.pointsRequired!) {
                                return Column(
                                  ...
                                  children: [
                                    ...
                                    const SizedBox(height: 10,),
                                    AppTexts.titleText("Vous devez avoir au moins ${current.pointsRequired} points pour faire une conversion."),
                                          ...
                                          builder: (context) {
                                            return Container(
                                                ...
                                                child: Column(
                                                  ...
                                                  children: [
                                                    AppTexts.titleText("Séléctionner la règle de conversion"),
                                                    const SizedBox(height: 20,),
                                                      ...
                                                      itemBuilder: (context, index) {
                                                        ...
                                                        return Padding(
                                                          ...
                                                          child: RoundedButton(
                                                            ...
                                                            title: "${cRule["points"]} Points   pour   ${cRule["amount"]} CAD",
                                                          ),
                                                        );
                                                      },
                                                    ))
