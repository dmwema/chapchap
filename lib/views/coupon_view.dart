          ...
          child: Column(
            ...
            children: [
              Padding(
                ...
                child: AppTexts.titleText(AppLocalizations.of(context)!.translate('myCoupons')),
              ),
                          ...
                          children: [
                            Column(
                              ...
                              children: [
                                ...
                                AppTexts.bodyText(
                                    AppLocalizations.of(context)!.translate('rebate10'), bold: true
                                ),
                                const SizedBox(height: 5.0),
                                SizedBox(
                                  width: 230,
                                  child: AppTexts.smallText(
                                      AppLocalizations.of(context)!.translate('referralInfo')
                                  ),
                                ),
                                ...
                                Row(
                                  ...
                                  children: [
                                    AppTexts.smallText(AppLocalizations.of(context)!.translate('referralCode')),
                                ...
                                Column(
                                  ...
                                  children: [
                                    AppTexts.cardDescription(
                                      AppLocalizations.of(context)!.translate('referralUrl'),
                                    ),
                                    const SizedBox(height: 5,),
                                    if (user != null)
                                      SelectableText('https://transfertchapchap.com/signup-${user!.codeParrainage}.html', style: GoogleFonts.poppins(
                        ...
                        child: Column(
                          ...
                          children: [
                            Column(
                              ...
                              children: [
                                AppTexts.bodyText(
                                    AppLocalizations.of(context)!.translate('earnings'), bold: true
                                ),
                                if (user != null)
                                  AppTexts.titleText(
                                ...
                                if (user != null)
                                  SizedBox(
                                    ...
                                    child: AppTexts.cardDescription(
                                      "${AppLocalizations.of(context)!.translate('youHave')} ${user!.soldeParrainage} ${user!.paysMonnaie ?? ''}",
                                    ),
                                  ),
                              ],
                            ),
                    ...
                    switch (value.promoList.status) {
                      ...
                      default:
                        if (value.promoList.data!.length == 0) {
                          return Center(
                            child: AppTexts.descriptionText(AppLocalizations.of(context)!.translate('noPromoCodes')),
                          );
                        }
                          ...
                          child: Padding(
                            ...
                            child: Column(
                              ...
                              children: [
                                ListView.builder(
                                  shrinkWrap: true,
                                  itemCount: value.promoList.data!.length,
                                  itemBuilder: (context, index) {
                                    return Container(
                                      ...
                                      child: Column(
                                        ...
                                        children: [
                                          AppTexts.smallText("${AppLocalizations.of(context)!.translate('type')}: ${value.promoList.data![index]["typeCodePromo"]}"),
                                          const SizedBox(height: 5,),
                                          AppTexts.smallText("${AppLocalizations.of(context)!.translate('code')}: ${value.promoList.data![index]["codePromo"]}"),
                                          const SizedBox(height: 5,),
                                          AppTexts.smallText("${AppLocalizations.of(context)!.translate('amount')}: ${value.promoList.data![index]["montantCodePromo"]}"),
                                        ],
                                      ),
                                    );
                                  },
