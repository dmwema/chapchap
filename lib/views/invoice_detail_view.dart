...
class InvoiceDetailView extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: CustomAppBar(
        title: AppLocalizations.of(context)!.translate('invoiceF12321'),
        showBack: true,
      ),
        ...
        child: Padding(
          ...
          child: Column(
            ...
            children: [
              ...
              Text(AppLocalizations.of(context)!.translate('date'), style: TextStyle(
                      ...
                      child: Container(
                        ...
                        child: Row(
                          children: [
                            ...
                            SizedBox(width: 10),
                            Text(AppLocalizations.of(context)!.translate('pay'), style: TextStyle(
                                color: Colors.white
                            ))
                          ],
                        ),
