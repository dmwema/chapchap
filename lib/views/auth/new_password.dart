                ...
                children: [
                  Padding(
                    ...
                    child: Column(
                      ...
                      crossAxisAlignment: CrossAxisAlignment.start,
                      children: [
                        AppTexts.titleText(localizations.resetPasswordTitle),
                        const SizedBox(height: 10,),
                        AppTexts.smallText(localizations.resetPasswordDescription),
                        const SizedBox(height: 10,),
                        InkWell(
                          onTap: () async {
                            if (!resending) {
                          ...
                          child: Row(
                            children: [
                              ...
                              AppTexts.bodyText(localizations.resendCode, bold: true),
                            ],
                          ),
                        ),
                        ...
                        CustomFormField(
                          ...
                          hint: localizations.codeHint,
                          controller: _codeController,
                          maxLines: 1,
                        ),
                        const SizedBox(height: 20,),
                        AppTexts.smallText(localizations.createNewPassword),
                        const SizedBox(height: 10,),
                        CustomFormField(
                            ...
                            onPress: () async {
                              if (!authViewModel.loading) {
                                if (_passCnfController.text.isEmpty || _passController.text.isEmpty || _codeController.text.isEmpty) {
                                  Utils.flushBarErrorMessage(localizations.allFieldsRequired, context);
                                } else {
                                  Map data = {
