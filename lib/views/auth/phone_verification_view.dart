...
class _PhoneVerificationState extends State<PhoneVerification> {
  ...
  Widget build(BuildContext context) {
    final AppLocalizations localizations = AppLocalizations.of(context); // Ajout de la localisation
          ...
          body: Column(
            children: [
              Padding(
                ...
                child: Column(
                  children: [
                    AppTexts.titleText(localizations.translate("phoneVerificationTitle")), // Utilisation de la traduction
                    ...
                    InkWell(
                        ...
                        child: Row(
                          children: [
                            ...
                            AppTexts.bodyText(localizations.translate("resendCode"), bold: true), // Traduction
                          ],
                        )
                    ),
                    const SizedBox(height: 20),
              ...
              Padding(
                padding: const EdgeInsets.symmetric(horizontal: 20),
                child: RoundedButton(
                  title: localizations.translate("validate"), // Traduction du bouton
                  loading: loading,
                  onPress: () async {
                    if (!loading) {
                      if (otp.length < 5) {
                        Utils.flushBarErrorMessage(localizations.translate("enterCompleteCode"), context); // Traduction
                        return;
                      }
                      setState(() {
                        loading = true;
