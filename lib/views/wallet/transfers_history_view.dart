...
import 'package:chapchap/l10n/app_localizations.dart';  // Importer pour les traductions
        ...
        child: Column(
          ...
          children: [
            Padding(
              ...
              child: AppTexts.titleText(AppLocalizations.of(context)!.translate('rechargeHistoryTitle')), // Utilisation de la clé pour la traduction
            ),
                  ...
                  switch (value.transfersList.status) {
                    ...
                    default:
                      if (value.transfersList.data!.length == 0) {
                        return Center(
                          child: Text(
                            AppLocalizations.of(context)!.translate('empty'), // Utilisation de la clé pour "Empty"
                            style: TextStyle(
                                      ...
                                      child: Column(
                                        ...
                                        children:  [
                                          ...
                                          Row(
                                            mainAxisAlignment: MainAxisAlignment.spaceBetween,
                                            children: [
                                              AppTexts.smallText(AppLocalizations.of(context)!.translate('amount')), // Utilisation de la clé
                                          ...
                                          Row(
                                            mainAxisAlignment: MainAxisAlignment.spaceBetween,
                                            children: [
                                              AppTexts.smallText(AppLocalizations.of(context)!.translate('date')), // Utilisation de la clé
                                          ...
                                          Row(
                                            mainAxisAlignment: MainAxisAlignment.spaceBetween,
                                            children: [
                                              AppTexts.smallText(AppLocalizations.of(context)!.translate('currency')), // Utilisation de la clé
                                            ...
                                            RoundedButton(
                                                onPress: () async {
                                                  ...
                                                  if(urllaunchable){
                                                    ...
                                                    Utils.toastMessage(AppLocalizations.of(context)!.translate('cannotOpenUrl')); // Utilisation de la clé pour le message d'erreur
                                                  }
                                                },
                                                color: AppColors.buttonBlackColor,
                                                title: AppLocalizations.of(context)!.translate('recharge'), // Utilisation de la clé
