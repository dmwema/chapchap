            ...
            children: [
                ...
                child: Column(
                  ...
                  children: [
                    Row(
                      ...
                      children: [
                        AppTexts.titleText(AppLocalizations.of(context).translate('wallets'), color: Colors.white),
                        // Row(
                        //   children: [
                                    ...
                                    default:
                                      ...
                                      if (user != null && wallets.isEmpty) {
                                        return RoundedButton(
                                          title: AppLocalizations.of(context)!.translate('createWalletButton'),
                  ...
                  children: [
                    Column(
                      ...
                      children: [
                        ...
                        AppTexts.descriptionText(AppLocalizations.of(context)!.translate('walletManagement'))
                      ],
                    ),
                  ],
                ),
              ...
              Padding(
                ...
                child: Column(
                  children: [
                    RoundedButton(
                        title: "${AppLocalizations.of(context)!.translate('rechargeAccount')} ${wallets.isNotEmpty ? wallets[currentWalletPage]['currency'] : ''}",
                        icon: Icons.wallet,
                    ...
                    const SizedBox(height: 10,),
                    RoundedButton(
                        title: AppLocalizations.of(context)!.translate('newTransfer'),
                    ...
                    if (user != null && user!.codePays == "ca")
                      RoundedButton(
                          title: AppLocalizations.of(context)!.translate('rechargeInfo'),
                          icon: Icons.payment,
                          color: AppColors.buttonBlackColor,
                          textColor: Colors.white,
                          onPress: () {
                    ...
                    const SizedBox(height: 10,),
                    AppTexts.cardTitle(AppLocalizations.of(context)!.translate('historical')),
                    const SizedBox(height: 20,),
                    RoundedButton(
                        title: "${AppLocalizations.of(context)!.translate('myRecharges')} ${wallets.isNotEmpty ? wallets[currentWalletPage]['currency'] : ''}",
                        icon: Icons.history,
                        color: AppColors.buttonBlackColor,
                        textColor: Colors.white,
                        onPress: () {
                    ...
                    const SizedBox(height: 10,),
                    RoundedButton(
                        title: "${AppLocalizations.of(context)!.translate('myTransfers')} ${wallets.isNotEmpty ? wallets[currentWalletPage]['currency'] : '' }",
                        icon: Icons.history,
                        color: AppColors.buttonBlackColor,
                        textColor: Colors.white,
                        onPress: () {
