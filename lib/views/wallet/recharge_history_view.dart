        ...
        child: Column(
          ...
          children: [
            Padding(
              ...
              child: AppTexts.titleText(AppLocalizations.of(context)!.translate('rechargeTitle')),  // Utilisation de AppLocalizations.of(context)!.translate()
            ),
                      ...
                      switch (value.rechargesList.status) {
                        ...
                        default:
                          if (value.rechargesList.data!.length == 0) {
                            return Center(
                              child: AppTexts.descriptionText(AppLocalizations.of(context)!.translate('emptyHistory')),  // Utilisation de AppLocalizations.of(context)!.translate()
                            );
                          }
                                          ...
                                          child: Column(
                                            ...
                                            children: [
                                              ...
                                              Row(
                                                mainAxisAlignment: MainAxisAlignment.spaceBetween,
                                                children: [
                                                  AppTexts.smallText(AppLocalizations.of(context)!.translate('amount')),  // Utilisation de AppLocalizations.of(context)!.translate()
                                              ...
                                              Row(
                                                mainAxisAlignment: MainAxisAlignment.spaceBetween,
                                                children: [
                                                  AppTexts.smallText(AppLocalizations.of(context)!.translate('date')),  // Utilisation de AppLocalizations.of(context)!.translate()
                                              ...
                                              Row(
                                                mainAxisAlignment: MainAxisAlignment.spaceBetween,
                                                children: [
                                                  AppTexts.smallText(AppLocalizations.of(context)!.translate('currency')),  // Utilisation de AppLocalizations.of(context)!.translate()
                                                ...
                                                RoundedButton(
                                                    onPress: () async {
                                                      ...
                                                      if(urllaunchable){
                                                        ...
                                                        Utils.toastMessage(AppLocalizations.of(context)!.translate('paymentUrlError'));  // Utilisation de AppLocalizations.of(context)!.translate()
                                                      }
                                                    },
                                                    color: AppColors.buttonBlackColor,
                                                    title: AppLocalizations.of(context)!.translate('recharge'),  // Utilisation de AppLocalizations.of(context)!.translate()
