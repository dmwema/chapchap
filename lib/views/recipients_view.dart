                                                                ...
                                                                InkWell(
                                                                  onTap: () {
                                                                    ...
                                                                    showModalBottomSheet(
                                                                      ...
                                                                      isScrollControlled: true,
                                                                      builder: (context) {
                                                                        return ConfirmArchive(recipientId: beneficiaire.idBeneficiaire!.toInt(), demandesViewModel: demandesViewModel3);
                                                                      },
                                                                  ...
                                                                  child: Container(
                                                                      ...
                                                                      child: Text("Archiver ${beneficiaire.nomBeneficiaire}", style: const TextStyle(color: Colors.white, fontWeight: FontWeight.bold, fontSize: 13),)
                                                                  ),
                                                                ),
                                                                const SizedBox(height: 10,),
                                                                InkWell(
