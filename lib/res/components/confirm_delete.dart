    ...
    return Padding(
      ...
      child: Column(
        ...
        children: [
          ...
          Column(
            children: [
              // Utilisation de translate('key') pour récupérer la traduction
              Text(
                localizations!.translate('confirm_delete_message') ?? "Voulez-vous vraiment supprimer ce bénéficiaire ?",
          ...
          Row(
            ...
            children: [
              RoundedButton(
                ...
                title: localizations.translate('delete') ?? "Supprimer",
              ),
