...
abstract class BaseApiServices {
  ...
  Future<dynamic> getPostApiResponse(String url, dynamic data, {required BuildContext context, bool auth = true, String contentType = "application/json", String? token});
  Future<dynamic> getPostDownloadApiResponse(String url, dynamic data, {required BuildContext context, bool auth = true, String contentType = "application/json"});
